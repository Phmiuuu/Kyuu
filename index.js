...
function title() {
	...
	console.log(color(`\n${themeemoji} YT CHANNEL: PhmiFz`,'magenta'))
console.log(color(`${themeemoji} GITHUB: Phmiuuu `,'magenta'))
...
console.log(color(figlet.textSync(`kyuuLonely`, {
font: 'Standard',
...
XeonLft = await getBuffer(ppuser)
                ...
                xeonbody = `@${xeonName.split("@")[0]} 𝙅𝙤𝙞𝙣𝙚𝙙 𝙏𝙤 𝙂𝙧𝙪𝙥 ${metadata.subject}`
...
"sourceUrl": `${wagc}`}}})
                    ...
                    xeonbody = `@${xeonName.split("@")[0]} 𝙇𝙚𝙖𝙫𝙞𝙣𝙜 𝙏𝙤 𝙂𝙧𝙪𝙥${metadata.subject}:`
XeonBotInc.sendMessage(anu.id,
 { text: xeonbody,
 contextInfo:{
 mentionedJid:[num],
...
} else if (connection === "open") { XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\n_Don't forget to support, bro :)_\n\nYouTube: https://youtube.com/@Basreng116\n\nGitHub: https://github.com/Phmiuuu\n\nInstsgram: https://instagram.com/basrenggood\n\nWhatsApp Pm: wa.me/6289687537657\n\n WhatsApp Gc1: https://chat.whatsapp.com/DAzQ5jmTToTKykUTgDMEBS\n\nWhatsApp Gc2: https://chat.whatsapp.com/DAzQ5jmTToTKykUTgDMEBS\n\nWhatsApp Gc3: https://chat.whatsapp.com/DAzQ5jmTToTKykUTgDMEBS\n\nDonate: https://prnt.sc/4RvtjEeIyrFH \n\n\n_*Thanks to*_\n_*4K Sanzz*_\n_*Myself*_\n_*Family*_\n_*Friends who helped me assemble this script*_` }); }
